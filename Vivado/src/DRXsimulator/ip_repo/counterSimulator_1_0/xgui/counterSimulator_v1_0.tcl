...
proc update_PARAM_VALUE.C_M00_counter_bits { PARAM_VALUE.C_M00_counter_bits } {
	# Procedure called to update C_M00_counter_bits when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_M00_counter_bits { PARAM_VALUE.C_M00_counter_bits } {
	# Procedure called to validate C_M00_counter_bits
	return true
}
...
proc update_MODELPARAM_VALUE.C_M00_counter_bits { MODELPARAM_VALUE.C_M00_counter_bits PARAM_VALUE.C_M00_counter_bits } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_M00_counter_bits}] ${MODELPARAM_VALUE.C_M00_counter_bits}
}
